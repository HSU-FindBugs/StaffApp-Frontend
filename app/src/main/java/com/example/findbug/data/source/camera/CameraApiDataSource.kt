...
class CameraApiDataSource @Inject constructor(
    ...
    fun addCamera(cameraRegisterRequestDto: CameraRegisterRequestDto): Flow<BaseResponse<CameraSaveResponse>> = flow {
    ...
    fun getCamera(member_id: Int): Flow<BaseListResponse<CameraListResponse>> = flow {
